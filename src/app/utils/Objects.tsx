...
export const SkillsIcons: SkillsProps[] = [
  {
    ...
    icon: (
      <Image
        alt="HTML"
        className="icon z-3 bg-white rounded-2 p-1"
...
export const Projects: ProjectsProps[] = [
  ...
  },
  {
    ...
    class: "JS",
    DemoLink:
      "https://basic-translator-3rci47y0x-alimohamed2345s-projects.vercel.app/",
  ...
  },
  {
    ...
    class: `React`,
    DemoLink: `https://movie-app-three-kohl.vercel.app/movie`,
    githubRepo: `https://github.com/aliMohamed2345/Movie-App`,
    ProjectImageSrc: Movie,
  },
];
